...
public class RabbitMQConfig {
    ...
    private final static String PROCESS_TEMPERATURE = "temperature-monitoring.processing-temperature.v1";
    public final static String QUEUE_PROCESS_TEMPERATURE = PROCESS_TEMPERATURE + ".q";
    public final static String DEAD_LETTER_QUEUE_PROCESS_TEMPERATURE = PROCESS_TEMPERATURE + ".dlq";
    public final static String QUEUE_ALERTING = "temperature-monitoring.alerting.v1.q";
